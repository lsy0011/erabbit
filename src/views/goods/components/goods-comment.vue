<template>
  <div class="goods-comment">
    ...
    <el-pagination
      ...
      :total="reqParams.page"
      :page-sizes="reqParams.pageSize"
      :page-count="commentList.counts"
      v-if="commentList?.pages > 1"
    />
  </div>
</template>
<script>
import useGoodsComment from "../../../hooks/useGoodsComments";
import GoodsCommentImage from "./goods-commentImage.vue";
